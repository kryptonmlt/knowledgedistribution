...
public class Plot2D extends ApplicationFrame {
    ...
    private final float STROKE_SIZE = 0.1f;
    ...
    public void addIncrementalSeries(List<Double> data, String name, Color c) {
        ...
        renderer.setSeriesStroke(counter, new BasicStroke(this.STROKE_SIZE + 1f));
        renderer.setSeriesShapesVisible(counter, false);
        dataset.addSeries(series);
        counter++;
    }

    public void addSeries(List<Coord2d> xy, String name, Color c, boolean increaseSize, boolean linesVisible) {
        final XYSeries series = new XYSeries(name);
        ...
        renderer.setSeriesShapesVisible(counter, !linesVisible);
        renderer.setSeriesLinesVisible(counter, linesVisible);
        dataset.addSeries(series);
        counter++;
    }
